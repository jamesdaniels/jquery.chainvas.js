...
jQuery(function($) {
  ...
  $.fn.getContext = function(dimension) {
    ...
    $('arc arcTo beginPath bezierCurveTo clearRect clearShadow clip closePath createImageData createLinearGradient createPattern createRadialGradient drawImage drawImageFromRect fill fillRect fillStyle fillText font getImageData globalAlpha globalCompositeOperation isPointInPath lineCap lineJoin lineTo lineWidth measureText miterLimit moveTo putImageData quadraticCurveTo rect restore rotate save scale setAlpha setCompositeOperation setFillColor setLineCap setLineJoin setLineWidth setMiterLimit setShadow setStrokeColor setTransform shadowBlur shadowColor shadowOffsetX shadowOffsetY stroke strokeRect strokeStyle strokeText textAlign textBaseline transform translate'.split(' ')).each(function(i) {
